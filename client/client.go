...
func (c *Client) getChunk(offset int64) (*TransactionChunkResponse, error) {
	...
	txChunk := &TransactionChunkResponse{}
...
func (c *Client) getTransactionOffset(id string) (*TransactionOffsetResponse, error) {
	...
	txOffset := &TransactionOffsetResponse{}
