...
// }
//
// func assemblyDataTx(bigData []byte, wallet *goar.Wallet, tags []schema.Tag) (*schema.Transaction, error) {
...
//
// 	tags := []schema.Tag{{Name: "Content-Type", Value: "application/pdf"}, {Name: "goar", Value: "testdata"}}
...
// 	assert.NoError(t, err)
//
// 	tags := []schema.Tag{{Name: "Content-Type", Value: "application/jpg"}, {Name: "goar", Value: "testdata"}}
//
// 	tx, err := assemblyDataTx(bigData, wallet, tags)
// 	assert.NoError(t, err)
// 	t.Log("txHash: ", tx.ID)
...
// 	assert.NoError(t, err)
//
// 	tags := []schema.Tag{{Name: "Content-Type", Value: "application/jpg"}, {Name: "goar", Value: "1.8mbPhoto"}}
// 	tx, err := assemblyDataTx(bigData, wallet, tags)
// 	assert.NoError(t, err)
// 	t.Log("txHash: ", tx.ID)
//
